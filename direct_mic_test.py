...
# --- Configuration ---
# MIC_INDEX = 11
MIC_INDEX = 18 # Use the NoMachine device identified by audio_test.py
# SAMPLE_RATE = 44100
SAMPLE_RATE = 48000 # Use supported rate for device 18
RECORD_DURATION_SECONDS = 10
OUTPUT_DIR = "tmp_output"
OUTPUT_FILENAME = "direct_mic_test_output.wav"
# CHANNELS = 1
CHANNELS = 2 # Match reported channels for device 18
# --- End Configuration ---
